...
```
## Warning in file(con, "r"): nie można otworzyć pliku 'Readme.Rmd': No such file or directory
```

```
## Error in file(con, "r"): nie można otworzyć połączenia
```
...
```
## Warning in file(con, "r"): nie można otworzyć pliku 'Readme.md': No such file or directory
```
